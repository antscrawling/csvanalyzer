...
def export_to_csv():
    ...
    try:
        with duckdb.connect('sales_timeseries.db', read_only=True) as con:
            ...
            if choice == '1':
                export_complete_dataset(con)
            elif choice == '2':
                export_sales_summary(con)
            elif choice == '3':
                export_hourly_analysis(con)
            elif choice == '4':
                export_discount_analysis(con)
            elif choice == '5':
                export_age_analysis(con)
            elif choice == '6':
                export_product_analysis(con)
            elif choice == '7':
                export_all_analyses(con)
            else:
...
def export_complete_dataset(con):
...
def export_hourly_analysis(con):
...
def export_discount_analysis(con):
...
def export_product_analysis(con):
